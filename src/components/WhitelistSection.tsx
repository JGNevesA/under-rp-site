      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="glass-card rounded-3xl p-8 md:p-12 max-w-4xl mx-auto glow-violet">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button className="w-full sm:w-auto px-8 py-4 rounded-xl gold-gradient font-bold text-black text-lg transition-all duration-300 hover:scale-105 glow-gold flex items-center justify-center gap-2">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
              </svg>
              Iniciar Whitelist
            </button>
            <button className="w-full sm:w-auto px-8 py-4 rounded-xl border border-gray-700 font-semibold text-white text-lg transition-all duration-300 hover:bg-white/5 flex items-center justify-center gap-2"
