        ...
        <div className="glass-card rounded-3xl p-8 md:p-12 max-w-4xl mx-auto glow-violet">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="w-full sm:w-auto px-8 py-4 rounded-xl theme-button font-bold text-black text-lg transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2"
            >
