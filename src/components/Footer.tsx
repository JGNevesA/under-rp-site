        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-lg bg-white/5 hover:bg-red-600 flex items-center justify-center text-gray-400 hover:text-white transition-all duration-300 border border-white/10 hover:border-red-600"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-lg bg-white/5 hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-500 flex items-center justify-center text-gray-400 hover:text-white transition-all duration-300 border border-white/10 hover:border-transparent"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-lg bg-white/5 hover:bg-black flex items-center justify-center text-gray-400 hover:text-white transition-all duration-300 border border-white/10 hover:border-white/30"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="pt-8 border-t border-white/5">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-500 text-sm">
              © 2024 UNDER RP. Todos os direitos reservados.
            </p>
            <div className="flex items-center gap-6">
              <p className="text-gray-500 text-xs">
                GTA V e FiveM são marcas registradas de seus respectivos proprietários.
              </p>
            </div>
          </div>
        </div>
