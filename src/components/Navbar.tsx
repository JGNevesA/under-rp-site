              ...
              <div className="flex items-center gap-3">
                ...
                {!user.steam_id && (
                  <button
                    ...
                    className="flex items-center justify-center gap-2 px-3 py-2 bg-[#171a21] hover:bg-[#2a475e] text-white text-xs font-medium rounded-lg transition-all border border-white/10 hidden sm:flex"
                  >
                    ...
                    <span>Vincular Steam</span>
                  </button>
                )}
                {!user.discord_id && (
                  <button
                    onClick={handleDiscordLogin}
                    className="flex items-center justify-center gap-2 px-3 py-2 bg-[#5865F2] hover:bg-[#4752c4] text-white text-xs font-medium rounded-lg transition-all hidden sm:flex"
                  >
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                ...
                {user ? (
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    {!user.steam_id && (
                      <button
                        onClick={handleSteamLogin}
                        className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-[#171a21] hover:bg-[#2a475e] text-white text-sm font-medium rounded-lg transition-all border border-white/10"
                      >
                        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                          <path d="M11.979 0C5.678 0 .511 4.86.022 10.942l6.432 2.658a3.387 3.387 0 011.912-.585c.064 0 .127.003.19.007l2.862-4.142v-.058a4.503 4.503 0 014.5-4.5 4.503 4.503 0 014.5 4.5 4.503 4.503 0 01-4.5 4.5h-.105l-4.076 2.91c0 .073.004.146.004.22a3.39 3.39 0 01-3.39 3.39 3.396 3.396 0 01-3.329-2.76L.308 15.597C1.87 20.562 6.533 24 11.979 24c6.627 0 12-5.373 12-12S18.606 0 11.979 0z" />
                        </svg>
                    ...
                    {!user.discord_id && (
                      <button
                        onClick={handleDiscordLogin}
                        className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-[#5865F2] hover:bg-[#4752c4] text-white text-sm font-medium rounded-lg transition-all"
                      >
                        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                          <path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028 14.09 14.09 0 0 0 1.226-1.994.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.892.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.956-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.418-2.157 2.418z" />
                        </svg>
